...
namespace Blockchain_Indexer.Migrations
{
    ...
    [Migration("20231213130133_WalletsTransactions")]
    partial class WalletsTransactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blockchain_Indexer.Transaction", b =>
                {
                    b.HasOne("Blockchain_Indexer.Wallet", "From")
                        .WithMany()
                        .HasForeignKey("FromAddress")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blockchain_Indexer.Wallet", "To")
                        .WithMany()
